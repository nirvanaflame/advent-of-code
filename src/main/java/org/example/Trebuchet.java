...
public class Trebuchet {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        final URL resource = Trebuchet.class.getResource("/input.txt");
        final List<String> list = Files.readAllLines(Paths.get(resource.toURI()));
        final int solve = solve(list);
        System.out.println(solve);

//        final int fouronevhnrz44 = solve2("4fouro4nevhnrz");
//        System.out.println(fouronevhnrz44);
    ...
    static String in = "fouronevhnrz44\n"
        + "eightg1\n"
